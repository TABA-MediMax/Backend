...
@Service
public class item_seqSearchService {
    ...
    @Autowired
    public item_seqSearchService(RestTemplate restTemplate) {
    ...
    public String searchText(String text) {
        try {
            ...
            urlBuilder.append("&" + URLEncoder.encode("itemSeq","UTF-8") + "=" + URLEncoder.encode(text, "UTF-8"));
